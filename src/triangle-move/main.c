...
int main(void) { 
    ...
    const char *vertex_file_path = "shaders/triangle-move/vertex.vert";
    const char *fragment_file_path = "shaders/triangle-move/color.frag";
    GLuint program;
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        // uncomment to animate the triangle
        //offset += 0.1;
